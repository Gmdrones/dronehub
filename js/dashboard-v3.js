    ...
    if(!pro){
      ...
      if(content){
        content.innerHTML='<section class="free-flight-deck">'
          +'<div class="free-deck-orbit"></div><div class="free-deck-copy"><span class="free-deck-eyebrow">DRONE HUB · FREE FLIGHT DECK</span><h2>Comece pelo que<br><em>importa para voar.</em></h2><p>Seu perfil, uma aeronave e uma leitura climática operacional em um painel claro, direto e pronto para a primeira missão.</p><div class="free-deck-actions"><a href="aeronaves.html" class="free-deck-primary">'+(aircraft?'Gerenciar aeronave':'Cadastrar aeronave')+'</a><a href="central-voo.html" class="free-deck-ghost">Abrir Central de Voo</a></div></div>'
